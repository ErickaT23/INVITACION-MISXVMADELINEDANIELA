...
async function seedEventData(arg1, arg2) {
  ...
  const sampleGuests = {
    "1": { id: "1", nombre: "Familia Carpio Menendez", pases: 7, activo: true },
    "2": { id: "2", nombre: "Familia Acevedo Carpio", pases: 4, activo: true },
    "3": { id: "3", nombre: "Familia Beza Avila", pases: 2, activo: true },
    "4": { id: "4", nombre: "Familia Paredes Madrid", pases: 3, activo: true },
    "5": { id: "5", nombre: "Tia Katherin Beza", pases: 5, activo: true },
    "6": { id: "6", nombre: "Tia Yuli Beza", pases: 2, activo: true },
    "7": { id: "7", nombre: "Familia Avila Granados", pases: 3, activo: true },
    "8": { id: "8", nombre: "Familia Sagüil Peña", pases: 5, activo: true },
    "9": { id: "9", nombre: "Familia Vargas Perez", pases: 3, activo: true },
    "10": { id: "10", nombre: "Tia Aida Cordon", pases: 1, activo: true },
    "11": { id: "11", nombre: "Familia Cardenas Gomez", pases: 5, activo: true },
    "12": { id: "12", nombre: "Familia Contreras Gomez", pases: 5, activo: true },
    "13": { id: "13", nombre: "Familia Garcia", pases: 3, activo: true },
    "14": { id: "14", nombre: "Familia Thomas Garcia", pases: 4, activo: true },
    "15": { id: "15", nombre: "Familia Chacón Menéndez", pases: 2, activo: true },
    "16": { id: "16", nombre: "Tia Rosa de Bellafiore", pases: 1, activo: true },
    "17": { id: "17", nombre: "Familia Gonzalez Menendez", pases: 2, activo: true },
    "18": { id: "18", nombre: "Familia Guerra Martinez", pases: 2, activo: true },
    "19": { id: "19", nombre: "Familia Sagastume Chacon", pases: 3, activo: true },
    "20": { id: "20", nombre: "Familia Sagastume Carles", pases: 4, activo: true },
    "21": { id: "21", nombre: "Pastor Marlon Lopez", pases: 2, activo: true },
    "22": { id: "22", nombre: "Familia Ixcoy Reyes", pases: 5, activo: true },
    "23": { id: "23", nombre: "Carla Garcia de Acevedo", pases: 1, activo: true },
    "24": { id: "24", nombre: "Familia Acevedo Zuñiga", pases: 4, activo: true },
    "25": { id: "25", nombre: "Jairo Lemus", pases: 1, activo: true },
    "26": { id: "26", nombre: "Cesia Acevedo", pases: 1, activo: true },
    "27": { id: "27", nombre: "Edgar Morales de Paz", pases: 1, activo: true },
    "28": { id: "28", nombre: "Wilny Stephenson", pases: 1, activo: true },
    "29": { id: "29", nombre: "Victoria Ventura", pases: 1, activo: true },
    "30": { id: "30", nombre: "Emely Solorzano", pases: 1, activo: true },
    "31": { id: "31", nombre: "Keyrin Hernandez", pases: 1, activo: true },
    "32": { id: "32", nombre: "Celeste Arita", pases: 1, activo: true },
    "33": { id: "33", nombre: "Kevin Montiel", pases: 1, activo: true },
    "34": { id: "34", nombre: "Byron Diaz", pases: 1, activo: true },
    "35": { id: "35", nombre: "Adelen Mendoza", pases: 1, activo: true },
    "36": { id: "36", nombre: "Fatima Lemus", pases: 1, activo: true },
    "37": { id: "37", nombre: "Valeria Aviles", pases: 1, activo: true },
    "38": { id: "38", nombre: "Ana Victoria Castillo", pases: 1, activo: true },
    "39": { id: "39", nombre: "Valentina Mijangos", pases: 1, activo: true },
    "40": { id: "40", nombre: "Darlin y Fernanda Vasquez", pases: 2, activo: true },
    "41": { id: "41", nombre: "Kimberly Alvarado", pases: 1, activo: true },
    "42": { id: "42", nombre: "Joselyn Sanabria", pases: 1, activo: true },
    "43": { id: "43", nombre: "Analia Garcia", pases: 1, activo: true },
    "44": { id: "44", nombre: "David Acevedo", pases: 1, activo: true },
    "45": { id: "45", nombre: "David Carrera", pases: 1, activo: true },
    "46": { id: "46", nombre: "Ryan Pacheco", pases: 1, activo: true },
    "47": { id: "47", nombre: "Nataly Suchini", pases: 1, activo: true },
    "48": { id: "48", nombre: "Stephanie Julian", pases: 2, activo: true },
    "49": { id: "49", nombre: "Adriana Perez", pases: 1, activo: true },
    "50": { id: "50", nombre: "Xiomara Jacome", pases: 1, activo: true },
    "51": { id: "51", nombre: "Ivan Onofre", pases: 1, activo: true },
    "52": { id: "52", nombre: "Danitza Navas", pases: 1, activo: true },
    "53": { id: "53", nombre: "Lucia Cervantes", pases: 1, activo: true },
    "54": { id: "54", nombre: "Nataly Vargas", pases: 1, activo: true },
    "55": { id: "55", nombre: "Selina Sandoval", pases: 2, activo: true },
    "56": { id: "56", nombre: "Melissa Pineda Picón", pases: 2, activo: true },
    "57": { id: "57", nombre: "Odeth Acevedo", pases: 1, activo: true },
    "58": { id: "58", nombre: "Familia Diaz Beza", pases: 5, activo: true },
    "59": { id: "59", nombre: "Sofia Moscoso", pases: 1, activo: true },
    "60": { id: "60", nombre: "Fatima Arita", pases: 1, activo: true },
    "61": { id: "61", nombre: "Familia Buezo Sagastume", pases: 3, activo: true },
    "62": { id: "62", nombre: "Familia Tian Sajquí", pases: 5, activo: true }
  };
