...
const GuestConfig = {
    invitados: {
        "1": { nombre: "Familia Carpio Menendez", pases: 7 },
        "2": { nombre: "Familia Acevedo Carpio", pases: 4 },
        "3": { nombre: "Familia Beza Avila", pases: 2 },
        "4": { nombre: "Familia Paredes Madrid", pases: 3 },
        "5": { nombre: "Tia Katherin Beza", pases: 5 },
        "6": { nombre: "Tia Yuli Beza", pases: 2 },
        "7": { nombre: "Familia Avila Granados", pases: 3 },
        "8": { nombre: "Familia Sagüil Peña", pases: 5 },
        "9": { nombre: "Familia Vargas Perez", pases: 3 },
        "10": { nombre: "Tia Aida Cordon", pases: 1 },
        "11": { nombre: "Familia Cardenas Gomez", pases: 5 },
        "12": { nombre: "Familia Contreras Gomez", pases: 5 },
        "13": { nombre: "Familia Garcia", pases: 3 },
        "14": { nombre: "Familia Thomas Garcia", pases: 4 },
        "15": { nombre: "Familia Chacón Menéndez", pases: 2 },
        "16": { nombre: "Tia Rosa de Bellafiore", pases: 1 },
        "17": { nombre: "Familia Gonzalez Menendez", pases: 2 },
        "18": { nombre: "Familia Guerra Martinez", pases: 2 },
        "19": { nombre: "Familia Sagastume Chacon", pases: 3 },
        "20": { nombre: "Familia Sagastume Carles", pases: 4 },
        "21": { nombre: "Pastor Marlon Lopez", pases: 2 },
        "22": { nombre: "Familia Ixcoy Reyes", pases: 5 },
        "23": { nombre: "Carla Garcia de Acevedo", pases: 1 },
        "24": { nombre: "Familia Acevedo Zuñiga", pases: 4 },
        "25": { nombre: "Jairo Lemus", pases: 1 },
        "26": { nombre: "Cesia Acevedo", pases: 1 },
        "27": { nombre: "Edgar Morales de Paz", pases: 1 },
        "28": { nombre: "Wilny Stephenson", pases: 1 },
        "29": { nombre: "Victoria Ventura", pases: 1 },
        "30": { nombre: "Emely Solorzano", pases: 1 },
        "31": { nombre: "Keyrin Hernandez", pases: 1 },
        "32": { nombre: "Celeste Arita", pases: 1 },
        "33": { nombre: "Kevin Montiel", pases: 1 },
        "34": { nombre: "Byron Diaz", pases: 1 },
        "35": { nombre: "Adelen Mendoza", pases: 1 },
        "36": { nombre: "Fatima Lemus", pases: 1 },
        "37": { nombre: "Valeria Aviles", pases: 1 },
        "38": { nombre: "Ana Victoria Castillo", pases: 1 },
        "39": { nombre: "Valentina Mijangos", pases: 1 },
        "40": { nombre: "Darlin y Fernanda Vasquez", pases: 2 },
        "41": { nombre: "Kimberly Alvarado", pases: 1 },
        "42": { nombre: "Joselyn Sanabria", pases: 1 },
        "43": { nombre: "Analia Garcia", pases: 1 },
        "44": { nombre: "David Acevedo", pases: 1 },
        "45": { nombre: "David Carrera", pases: 1 },
        "46": { nombre: "Ryan Pacheco", pases: 1 },
        "47": { nombre: "Nataly Suchini", pases: 1 },
        "48": { nombre: "Stephanie Julian", pases: 2 },
        "49": { nombre: "Adriana Perez", pases: 1 },
        "50": { nombre: "Xiomara Jacome", pases: 1 },
        "51": { nombre: "Ivan Onofre", pases: 1 },
        "52": { nombre: "Danitza Navas", pases: 1 },
        "53": { nombre: "Lucia Cervantes", pases: 1 },
        "54": { nombre: "Nataly Vargas", pases: 1 },
        "55": { nombre: "Selina Sandoval", pases: 2 },
        "56": { nombre: "Melissa Pineda Picón", pases: 2 },
        "57": { nombre: "Odeth Acevedo", pases: 1 },
        "58": { nombre: "Familia Diaz Beza", pases: 5 },
        "59": { nombre: "Sofia Moscoso", pases: 1 },
        "60": { nombre: "Fatima Arita", pases: 1 },
        "61": { nombre: "Familia Buezo Sagastume", pases: 3 },
        "62": { nombre: "Familia Tian Sajquí", pases: 5 }
    },
